  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#f5f0eb' }}>
      ...
      <div
        ...
        style={{ backgroundColor: '#8B4513', color: 'white', letterSpacing: '0.04em' }}
      >
        PREVIEW MODE — Flat beater logo + lifestyle hero · Not the live homepage
      </div>
      ...
      <section className="px-5 md:px-16 py-10 md:py-16" style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          {/* Left — identical to homepage */}
          <div
            className="w-full md:max-w-xl transition-all duration-700"
          ...
          {/* Right — LIFESTYLE PHOTO instead of hero.jpg */}
          <div
            className="hidden md:block relative flex-shrink-0 transition-all duration-1000"
            style={{
              opacity: loaded ? 1 : 0,
          ...
          >
            <div style={{ animation: 'float 6s ease-in-out infinite' }}>
              ...
              >
                {/* ↓ SWAPPED: hero-preview.jpg = the lifestyle photo */}
                <img
                  src="/hero-preview.PNG"
                  alt="Baker using a stand mixer"
                  className="w-full h-full object-cover"
                  style={{ objectPosition: 'center 20%' }}
                />
                <div
                  className="absolute inset-0"
                  style={{ background: 'linear-gradient(to top, rgba(45,26,14,0.3) 0%, transparent 60%)' }}
                />
              </div>
            </div>
            ...
            {featuredBaker && (
              <div
                className="absolute bg-white rounded-2xl px-5 py-4 shadow-xl"
            ...
            {/* Verified badge */}
            <div
              className="absolute bg-white rounded-2xl px-4 py-3 shadow-xl"
              style={{
                top: '-16px',
                right: '-16px',
          ...
          <div className="md:hidden w-full">
            <div className="rounded-2xl overflow-hidden shadow-xl relative" style={{ height: '320px' }}>
              ...
              <div
                className="absolute inset-0"
                style={{ background: 'linear-gradient(to top, rgba(45,26,14,0.4) 0%, transparent 60%)' }}
              />
              {featuredBaker && (
                <Link
                  href={'/bakers/' + featuredBaker.id}
