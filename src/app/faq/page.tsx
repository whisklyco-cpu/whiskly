  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Yes. The free tier includes everything you need to run your business — order management, customer messaging, delivery and pickup flow, reviews, and unlimited orders. There\'s no commission on transactions during our beta period.'
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'You can reach us at support@whiskly.com. Pro bakers receive priority support with faster response times.'
      },
      {
    ...
    <main className="min-h-screen" style={{ backgroundColor: '#f5f0eb' }}>
      ...
      <section className="px-6 md:px-16 pb-20" style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div className="mt-10 rounded-2xl p-8 text-center" style={{ backgroundColor: '#2d1a0e' }}>
          ...
          <a href="mailto:support@whiskly.com"
